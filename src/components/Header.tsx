...
export default function Header() {
  ...
  return (
    <header
      className={`fixed w-full top-0 z-50 backdrop-blur-md bg-white/80 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-700/50 transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex items-center justify-between">
          <Link href="/">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold text-slate-900 dark:text-white font-sans">Portfolio TPs AN</h1>
            </div>
          </Link>
              ...
              <Link
                ...
                className={`font-sans px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                  enlace.activo
                    ...
                    : 'text-slate-600 hover:text-blue-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:text-blue-400 dark:hover:bg-slate-800/60'
                }`}
              >
                {enlace.etiqueta}
              </Link>
          ...
          <div className="flex items-center gap-1 md:hidden">
            ...
            <button
              ...
              className="flex items-center justify-center w-10 h-10 rounded-lg text-slate-600 hover:text-blue-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:text-blue-400 dark:hover:bg-slate-800/60 transition-colors"
            >
