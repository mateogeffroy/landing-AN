  ...
  return (
    <main className="min-h-screen flex flex-col fondo-cuadriculado">
      ...
      <section className="relative flex flex-col justify-center items-center text-center px-4 pt-40 pb-24 min-h-[65vh] w-full max-w-5xl mx-auto overflow-hidden">
        ...
        <RevelarAlEntrar>
          <p className="text-[11px] font-black uppercase tracking-[0.25em] text-blue-400 mb-5">
      ...
      <section id="proyectos" className="px-4 max-w-6xl mx-auto w-full mb-24">
        <RevelarAlEntrar>
          <h2 className="text-3xl md:text-4xl font-bold mb-2 text-center text-white tracking-wide">
            Proyectos
          </h2>
          <p className="text-center text-slate-400 mb-10">Cada trabajo práctico, resuelto y explicado como un capítulo aparte.</p>
        </RevelarAlEntrar>
          ...
          <div className="bg-slate-800/30 backdrop-blur rounded-2xl p-8 md:p-12 border border-slate-700/50 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {integrantes.map((persona) => (
                <div key={persona.legajo} className="bg-slate-800/80 hover:bg-slate-800 rounded-xl p-6 border border-slate-700 transition-colors shadow-inner">
                  <h3 className="text-lg font-bold text-white mb-2">{persona.nombre}</h3>
                  <p className="text-slate-400 text-sm mb-1"><span className="text-blue-400 font-semibold">Legajo:</span> {persona.legajo}</p>
                  <p className="text-slate-400 text-sm"><span className="text-blue-400 font-semibold">Email:</span> {persona.email}</p>
                </div>
              ))}
            </div>
          </div>
